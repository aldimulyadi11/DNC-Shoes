          ...
          <div class="col-lg-7 mx-auto">
            ...
            <div class="auto-form-wrapper">
               @if(\Session::has("alert"))
                ...
                <form action="{{url("/registerPembelianEvent/".$datas->kode_penjualan)}}" method="POST">          
                  {{ csrf_field() }}
                ...
                <div class="form-group">
                  ...
                  <a href="{{url("detailPembelianEvent/".$datas->kode_penjualan)}}" class="btn btn-info submit-btn btn-block">Cancel</a>
                </div>
              </form>
              @endforeach
            </div>
