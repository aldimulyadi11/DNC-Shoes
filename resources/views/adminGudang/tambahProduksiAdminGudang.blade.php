            ...
            <div class="auto-form-wrapper">
              @if(\Session::has("alert"))
               ...
               @if ($errors->any())
                ...
                <form action="{{url("/registerProduksiAdminGudang")}}" method="POST">          
                  {{ csrf_field() }}

                <div class="form-group">
                  <label class="label">Tanggal Produksi</label>
                  <div class="input-group">
                    <input autocomplete="off" required="" type="date" class="form-control" name="tanggal_produksi">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input autocomplete="off" required="" type="number" class="form-control" name="jumlah" placeholder="Jumlah">
                    <div class="input-group-append">                      
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea required="" required="" class="form-control" id="exampleTextarea1" rows="4" name="keterangan"></textarea>
                </div>

                <div class="form-group">
                  <button class="btn btn-success submit-btn btn-block">Submit</button>
                  <a href="{{url("dataProduksiAdminGudang")}}" class="btn btn-info submit-btn btn-block">Cancel</a>
                </div>
              </form>
            </div>
          </div>
