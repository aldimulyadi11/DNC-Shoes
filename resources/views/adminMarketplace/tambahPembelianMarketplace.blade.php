          ...
          <div class="col-lg-7 mx-auto">
            ...
            <div class="auto-form-wrapper">
               @if(\Session::has("alert"))
                ...
                <form action="{{url("/registerPembelianMarketplace/".$datas->kode_penjualan)}}" method="POST">          
                  {{ csrf_field() }}
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input required="" type="number" class="form-control" value="0" name="ongkir" id="ongkir" >
                    <div class="input-group-append">                      
                    </div>
                  </div>
                </div>                
                ...
                <div class="form-group">
                  ...
                  <a href="{{url("detailPembelianMarketplace/".$datas->kode_penjualan)}}" class="btn btn-info submit-btn btn-block">Cancel</a>
                </div>
              </form>
              @endforeach
            </div>
