          ...
          <div class="col-lg-7 mx-auto">
            ...
            <div class="auto-form-wrapper">
               @if(\Session::has("alert"))
                ...
                <form action="{{url("/registerPembelianToko/".$datas->kode_penjualan)}}" method="POST">          
                  {{ csrf_field() }}
                ...
                <a href="{{url("detailPembelianToko/".$datas->kode_penjualan)}}" class="btn btn-info submit-btn btn-block">Cancel</a>
                </div>
              </form>
              @endforeach
            </div>
