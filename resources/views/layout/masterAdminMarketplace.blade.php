            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        <li class="nav-item"><a href="{{url("dashboardAdminMarketplace")}}"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Dashboard</span></a>
                        </li>

                        <li class="nav-item"><a href="{{url("dataProdukAdminMarketplace")}}"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Produk</span></a>
                        </li>

                        <li class="nav-item"><a href="{{url("dataStokAdminMarketplace")}}"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Stok Produk</span></a>
                        </li>
                        <li class="nav-item"><a href="{{url("dataProduksiAdminMarketplace")}}"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Produksi</span></a>
                        </li>
                        <li class="nav-item"><a href="{{url("dataPenjualanMarketplace")}}"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Data Penjualan</span></a>
                        </li>
                    </ul>
                </div>
            </nav>
                        ...
                        <div class="row">
                            <div class="col-lg-1 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="admin-logo logo-wrap-pro">
                                    <a href="{{url("/asset/#")}}"><img src="{{url("/asset/img/logo/logo.png")}}" width="50%" height="50%"/>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-11 col-md-5 col-sm-6 col-xs-12">
                                <div class="header-right-info">
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url("/asset/#")}}" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                <span class="adminpro-icon adminpro-user-rounded header-riht-inf"></span>
                                                <span class="admin-name">{{Session::get("nama")}}</span>
                                                <span class="author-project-icon adminpro-icon adminpro-down-arrow"></span>
                                            </a>
                                            <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated flipInX">
                                                <li><a href="{{url("changePassMarket/".Session::get("id_market"))}}"><span class="adminpro-icon adminpro-home-admin author-log-ic"></span>Change Password</a>
                                                </li>                                                
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript">
     ...
     function jumlah() {
      ...
      function diskon() {
        var dis = document.getElementById('radio_1');
        var diss = document.getElementById('radio_2');
        if(dis.checked == true){
            ...
            document.getElementById("total").value=total;
        }else if(diss.checked == true){
            var harga = parseInt(document.getElementById("harga_jual").value);
            var jumlah = parseInt(document.getElementById("jumlah").value);
            var disk = parseInt(document.getElementById("diskon").value);
            var total = (harga* jumlah) - disk;
            document.getElementById("total").value=total;
        }
      }
  </script>
