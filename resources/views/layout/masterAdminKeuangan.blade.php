...
<body class="materialdesign">
            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        <li class="nav-item"><a href="{{url("dashboardAdminKeuangan")}}"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Dashboard</span></a>
                        </li>
                        
                        
                        <li class="nav-item"><a href="{{url("dataAkunPengeluaranKeuangan")}}"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Data Akun</span></a>
                        </li>

                        <li class="nav-item"><a href="{{url("dataPengeluaranKeuangan")}}" class="dropdown-item">Pengeluaran </a>
                        </li>
                    </ul>
                </div>
            </nav>
                                    ...
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                        <li class="nav-item">
                                            ...
                                            <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated flipInX">
                                                <li><a href="{{url("changePassKeuangan/".Session::get("id_keuangan"))}}"><span class="adminpro-icon adminpro-home-admin author-log-ic"></span>Change Password</a>
                                                </li>                                                
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li class="nav-item"><a href="{{url("dataPengeluaran")}}"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Pengeluaran</span></a>
                                        </li>                        
  ...
  <!-- endinject -->
  <script>
      function hapusPengeluaran($del){
        if(confirm("Are You Sure")){
            window.location=("hapusPengeluaranKeuangan/" +$del+ "");
        }
      }

      function hapusAkunPengeluaran($del){
        if(confirm("Are You Sure")){
            window.location=("hapusAkunPengeluaranKeuangan/" +$del+ "");
        }
      }
