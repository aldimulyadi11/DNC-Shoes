                ...
                <div class="col-lg-12">
                    <div class="sparkline13-list shadow-reset">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1>Laporan Aset Gudang<span class="table-project-n"></span></h1>
                    ...
                    @endforeach
                      ...
                      <option  value="Toko">Toko</option>
                                ...
                                <br>
                                <h4><strong>Laporan Asset Gudang</strong></h4>
                                <br>
                                <a href="{{url("cetakLaporanAssetGudang/")}}" target="_blank" class="btn btn-custon-four btn-info"><i class="fa fa-print"></i> Cetak Laporan</a>
                                <br><br>
                                ...
                                @foreach($tamp as $data)                         
                                    <tr>
                                        ...
                                        <td>Rp. {{number_format($data->stok_gudang * $data->harga_jual)}} </td>
                                    </tr>
                                    @php 
                                      $total += $data->stok_gudang *$data->harga_jual;
                                    @endphp
                                @endforeach
                              </tbody>
                              <tfoot>
