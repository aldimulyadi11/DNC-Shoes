            ...
            <div class="auto-form-wrapper">
              ...
              @if(\Session::has("alert"))
               ...
               @if ($errors->any())
                ...
                <form action="{{url("/updateKategori/".$data->kode_kategori)}}" method="POST">          
                  {{ csrf_field() }}

                <div class="form-group">     
                  <label class="label">Kode Kategori</label>             
                  <div class="input-group">
                    <input autocomplete="off" type="text" class="form-control" readonly="" name="kode_kategori" value="{{$data->kode_kategori}}">
                ...
                <label class="label">Nama Kategori</label>            
                  <div class="input-group">
                    <input autocomplete="off" type="text" class="form-control" name="nama_kategori" value="{{$data->nama_kategori}}">
                    <div class="input-group-append">                      
                    </div>
                  </div>
                </div>
