...
<body>
  ...
  <center>
    <p><strong>LAPORAN ASSET DNC-SHOES<br><br> </strong><br><br> www.dnc-shoes.com </p>
    <br>
    ...
    <thead>
      ...
      @foreach($tamp as $data)                             
          <tr>
              ...
              <td id="tengah">Rp. {{number_format($data->harga_jual,0, ".", ".")}}</td>
              <td>Rp. {{number_format(($data->stok_gudang+ $data->stok_toko)*$data->harga_jual)}}</td>
          </tr>
          @php $total += ($data->stok_gudang + $data->stok_toko) *$data->harga_jual;@endphp
      @endforeach    
      </tbody>
      <tfoot>
      <tr >
