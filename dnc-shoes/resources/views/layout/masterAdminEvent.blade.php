            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        <li class="nav-item"><a href="{{url("dashboardAdminEvent")}}"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Dashboard</span></a>
                        </li>

                        <li class="nav-item"><a href="{{url("dataProdukAdminEvent")}}"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Produk</span></a>
                        </li>

                        <li class="nav-item"><a href="{{url("dataStokAdminEvent")}}"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Stok Produk</span></a>
                        </li>
                        <li class="nav-item"><a href="{{url("dataProduksiAdminEvent")}}"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Produksi</span></a>
                        </li>

                        <li class="nav-item"><a href="{{url("dataPenjualanEvent")}}"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Data Penjualan</span></a>
                        </li>
                    </ul>
                </div>
            </nav>
                                    ...
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                        <li class="nav-item">
                                            ...
                                            <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated flipInX">
                                                <li><a href="{{url("changePassEvent/".Session::get("id_event"))}}"><span class="adminpro-icon adminpro-home-admin author-log-ic"></span>Change Password</a>
                                                </li>                                               
