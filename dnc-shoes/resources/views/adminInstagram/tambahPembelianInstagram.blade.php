          ...
          <div class="col-lg-7 mx-auto">
            ...
            <div class="auto-form-wrapper">
               @if(\Session::has("alert"))
                ...
                <form action="{{url("/registerPembelianInstagram/".$datas->kode_penjualan)}}" method="POST">          
                  {{ csrf_field() }}
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input autocomplete="off" type="number" class="form-control"  name="jumlah" id="jumlah">
                    <div class="input-group-append">                      
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <a href="{{url("detailPembelianInstagram/".$datas->kode_penjualan)}}" class="btn btn-info submit-btn btn-block">Cancel</a>
                </div>
              </form>
              @endforeach
            </div>
