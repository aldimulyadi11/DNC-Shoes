                ...
                <div class="col-lg-12">
                  ...
                  @endif
                    ...
                    <br><br>
                                ...
                                <div id="toolbar">
                                    <a href="{{url("dataPenjualanInstagram")}}" class="btn btn-custon-four btn-danger"> Kembali </a>
                                    @foreach($tamps as $datas)    
                                    <a href="{{url("tambahPembelianInstagram/".$datas->kode_penjualan)}}" class="btn btn-custon-four btn-info"><i class="fa fa-plus-square"></i> Tambah Produk</a>
