            ...
            <div class="auto-form-wrapper">
              @if(\Session::has("alert"))
               ...
               @if ($errors->any())
                ...
                <form action="{{url("/registerReturnAdminGudang")}}" method="POST">          
                  {{ csrf_field() }}

                <div class="form-group">  
                <label class="label">Tanggal Return</label>                
                ...
                <div class="form-group">
                  ...
                  <a href="{{url("dataReturn")}}" class="btn btn-info submit-btn btn-block">Cancel</a>
                </div>
              </form>
            </div>
          </div>
