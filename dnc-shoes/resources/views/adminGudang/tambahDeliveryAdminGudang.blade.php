            ...
            <div class="auto-form-wrapper">
              @if(\Session::has("alert"))
               ...
               @if ($errors->any())
                ...
                <form action="{{url("/registerDeliveryAdminGudang")}}" method="POST">          
                  {{ csrf_field() }}

                <div class="form-group">
                  <label class="label">Tanggal Delivery</label>
                  <div class="input-group">
                    <input autocomplete="off" required="" type="date" class="form-control" name="tanggal_delivery">
                ...
                <div class="form-group">
                  ...
                  <a href="{{url("dataDeliveryAdminGudang")}}" class="btn btn-info submit-btn btn-block">Cancel</a>
                </div>
              </form>
            </div>
          </div>
