          ...
          <div class="col-lg-7 mx-auto">
            ...
            <div class="auto-form-wrapper">
               ...
               @if ($errors->any())
                ...
                <form action="{{url("/updateProduk/".$data->kode_produk)}}" method="POST" enctype="multipart/form-data">          
                  {{ csrf_field() }}
                ...
                <label class="label">Nama Produk</label>        
                  <div class="input-group">
                    <input autocomplete="off" type="text" class="form-control" name="nama_produk" value="{{$data->nama_produk}}">
                    <div class="input-group-append">                      
                    </div>
                  </div>
                </div>
                ...
                <label class="label">Harga</label>               
                  <div class="input-group">
                    <input autocomplete="off" type="number" class="form-control" name="harga_jual" value="{{$data->harga_jual}}">
                    <div class="input-group-append">                      
                    </div>
                  </div>
                </div>
                ...
                <label class="label">Stok Minimum</label>                
                  <div class="input-group">
                    <input autocomplete="off" type="number" class="form-control" name="stok_minimum" value="{{$data->stok_minimum}}">
                    <div class="input-group-append">                      
                    </div>
                  </div>
                </div>
