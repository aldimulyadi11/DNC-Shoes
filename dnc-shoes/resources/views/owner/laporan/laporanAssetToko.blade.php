                ...
                <div class="col-lg-12">
                    <div class="sparkline13-list shadow-reset">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1>Laporan Aset Toko<span class="table-project-n"></span></h1>
                    ...
                    @endforeach
                      ...
                      <option  value="Toko">Toko</option>
                                ...
                                <br>
                                <h4><strong>Laporan Asset Toko</strong></h4>
                                <br>
                                <a href="{{url("cetakLaporanAssetToko/")}}" target="_blank" class="btn btn-custon-four btn-info"><i class="fa fa-print"></i> Cetak Laporan</a>
                                <br><br>
